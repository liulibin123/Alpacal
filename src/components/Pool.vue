    ...
    <div class="pool">
        <div class="pool_body">
            <div class="pool_header">
                <div>
                    <img src="../assets/images/token.svg" alt="">
                    <div>
                        <h4>Auto CAKE</h4>
                ...
                <div>
                    <div @click="handleTotal">Total staked</div>
                    <div>90,879,237 CAKE</div>
                </div>
                <div>
                    <div>Ends in</div>
                    <div>-</div>
            ...
            <div class="pool_article" v-if="isShow">
                ...
                <div>
                    <div>ENABLE POOL</div>
                    <div @click="handleEnable">Enable</div>
                </div>
            </div>
        </div>
...
export default ({
    ...
    methods: {
        ...
        handleApy() {
            ...
            const myContract = new web3js.eth.Contract(approveABI, '0x3Fb6a6DcF90C674E255cBdA0d19a28d01b90D819')
            myContract.methods.approve('0x7d3341D090250399F45C6B43996A88c42E5B47Fe', 100000000).send({from: '0x3085284c0C028467f07f4bb9C6B739D26ac1bcF7'}).then(function(err,result){
                console.log(result)
            })
            ...
            const myContract1 = new web3js.eth.Contract(user_stakedABI, '0x7d3341D090250399F45C6B43996A88c42E5B47Fe')
            myContract1.methods.user_staked('0x3085284c0C028467f07f4bb9C6B739D26ac1bcF7').call().then(result =>{
        ...
        async handleEnable() {
            let web3js = getProvider()
            // approve('0x3Fb6a6DcF90C674E255cBdA0d19a28d01b90D819','0x9ac64cc6e4415144c455bd8e4837fea55603e5c3');
            ...
            await myContract1.methods.getReserves().call().then(result =>{
                // let b = new BigNumber(result)
                // console.log(b.toString())
                console.log(result._reserve0, result._reserve1)
            })
            // console.log(getReservesABI)
        }
    }
})
</script>
...
.pool_article>:nth-child(2)>div:first-child {
...
.pool_article>:nth-child(2)>div:first-child>div:last-child {
    margin-top: 20px;
    color: rgb(189, 194, 196)
}
.pool_article>:nth-child(2)>div:first-child>div:last-child>div:first-child {
    font-size: 20px;
    font-weight: 700;
}
.pool_article>:nth-child(2)>div:last-child {
    font-size: 14px;
    margin-top: 20px;
    color:rgb(40, 13, 95);
}
.pool_article>:nth-child(3) {
    flex: 3 0 200px;
...
.pool_article>:nth-child(3)>div:first-child {
    font-size: 14px;
    color: rgb(40, 13, 95)
}
.pool_article>:nth-child(3)>div:last-child {
    display: flex;
    align-items: center;
    justify-content: center;
    height: 50px;
