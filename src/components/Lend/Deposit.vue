        ...
        <div class="deposit_back">
            <div class="deposit_article">
                ...
                <div class="deposit_back_icon">
                    ...
                    <div @click="handleDeposit">Approve</div>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        handleDeposit() {
            ...
            myContract1.methods.deposit(amount.toString()).send({from: '0x3085284c0C028467f07f4bb9C6B739D26ac1bcF7',gas: 10000000},function(err,result){
                console.log(result)
            })
        }
    }
